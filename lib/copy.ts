    ...
    columns: [
      {
        ...
        items: [
          { de: 'Funktionen', en: 'Features' } as Bi,
          { de: 'iOS App', en: 'iOS app' } as Bi,
          { de: 'Android App', en: 'Android app' } as Bi,
          { de: 'Web Reader', en: 'Web reader' } as Bi,
        ],
      },
      {
        heading: { de: 'Redaktion', en: 'Newsroom' } as Bi,
        items: [
          { de: 'Über uns', en: 'About' } as Bi,
          { de: 'Standards', en: 'Standards' } as Bi,
          { de: 'Methodik', en: 'Method' } as Bi,
          { de: 'Jobs', en: 'Careers' } as Bi,
        ],
      },
      {
        heading: { de: 'Rechtliches', en: 'Legal' } as Bi,
        items: [
          { de: 'Impressum', en: 'Imprint' } as Bi,
          { de: 'Datenschutz', en: 'Privacy' } as Bi,
          { de: 'AGB', en: 'Terms' } as Bi,
          { de: 'Presse', en: 'Press' } as Bi,
          { de: 'Kontakt', en: 'Contact' } as Bi,
        ],
      },
    ],
    rights: {
